...
export const RecyclingBinDrawer = () => {
  ...
  return (
    <motion.aside
      ...
      className="fixed right-0 top-16 bottom-0 w-96 bg-white dark:bg-zinc-900 border-l border-zinc-200 dark:border-zinc-800 flex flex-col z-40 shadow-2xl shadow-black/20"
    >
      {/* Header */}
