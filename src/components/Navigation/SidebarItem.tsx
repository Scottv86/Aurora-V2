  ...
  return (
    <button
      ...
      className={cn(
        ...
        collapsed ? "justify-center px-0 py-2" : "gap-3 px-3 py-2 rounded-lg",
    ...
    >
      <Icon size={18} className={cn("shrink-0 transition-colors", active ? "text-indigo-600 dark:text-white" : isComingSoon ? "text-zinc-300 dark:text-zinc-700" : "text-zinc-400 dark:text-zinc-500 group-hover:text-zinc-600 dark:group-hover:text-zinc-300")} />
      {!collapsed && (
        <>
