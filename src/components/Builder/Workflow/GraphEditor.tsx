  ...
  return (
    <div className="h-full w-full bg-transparent flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-72 border-r border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 flex flex-col overflow-hidden">
          {/* Search Header - Exactly like Builder */}
          <div className="p-6 border-b border-zinc-200 dark:border-zinc-800 bg-transparent">
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl pl-9 pr-4 py-2.5 text-xs text-zinc-900 dark:text-white focus:outline-none focus:border-indigo-500/80 focus:ring-2 focus:ring-indigo-500/20 transition-all placeholder-zinc-400"
              />
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-6 custom-scrollbar">
            ...
            {[
              ...
              <button
                ...
                className={cn(
                  "group flex flex-col gap-2 p-4 rounded-2xl border border-zinc-200 dark:border-zinc-800 text-left transition-all hover:scale-[1.02] active:scale-[0.98]",
                  "bg-white dark:bg-zinc-800/80 hover:border-indigo-500/50 hover:bg-zinc-50 dark:hover:bg-zinc-800 hover:shadow-xl hover:shadow-indigo-500/5"
                )}
              >
        ...
        <AnimatePresence mode="wait">
          {showDebugger && workflow && (
            <motion.div
              ...
              exit={{ opacity: 0, x: 20 }}
              className="w-96 h-full z-20 border-l border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 flex flex-col overflow-hidden"
            >
              {/* Tab Switcher */}
