...
export const ValidationsTab: React.FC<ValidationsTabProps> = ({
  ...
  const [rightTab, setRightTab] = useState<'sandbox' | 'ai'>('sandbox');
  ...
  return (
    <div className="flex h-full w-full bg-transparent overflow-hidden divide-x divide-zinc-200 dark:divide-zinc-800">
      ...
      {selectedRuleId !== null || name ? (
        <aside className="w-64 flex-shrink-0 bg-white dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-800 p-6 flex flex-col gap-4">
      ...
      {/* 4. Right Sidebar (Sandbox & AI Assist) */}
      {selectedRuleId !== null || name ? (
        <aside className="w-80 flex-shrink-0 bg-white dark:bg-zinc-900 border-l border-zinc-200 dark:border-zinc-800 p-6 flex flex-col gap-6 overflow-y-auto custom-scrollbar">
          {/* Tab Selector */}
          ...
          {rightTab === 'sandbox' ? (
            <div className="flex flex-col gap-6 flex-1 min-h-0">
              ...
              <div className="space-y-3 pt-4 border-t border-zinc-100 dark:border-zinc-900 shrink-0">
                <button
                  ...
                  className="w-full py-2.5 bg-zinc-900 dark:bg-zinc-100 hover:bg-indigo-650 hover:text-white dark:hover:bg-indigo-650 text-white dark:text-zinc-900 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer"
                >
                  <Play size={10} />
                  Evaluate Expression
                </button>
            ...
            <div className="flex flex-col gap-6 flex-1 min-h-0">
              <div className="space-y-1">
                <h3 className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">AI Rule Builder</h3>
                <p className="text-[9px] text-zinc-400 leading-relaxed">
                  Describe the constraint in plain English, and the AI will auto-compile it into an expression.
                </p>
              </div>
