...
export const DocsApp = () => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)] w-full bg-zinc-50/50 dark:bg-zinc-950/50 overflow-y-auto relative p-6 lg:p-12 space-y-10 custom-scrollbar">
      {/* Background Orbs */}
      ...
      <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between relative z-10">
        ...
        <button
          ...
          className="flex items-center gap-2 px-5 py-2.5 bg-indigo-600 text-white rounded-2xl text-xs font-bold hover:bg-indigo-500 shadow-xl shadow-indigo-500/20 transition-all cursor-pointer"
        >
          <Plus size={18} />
          New Document
        </button>
