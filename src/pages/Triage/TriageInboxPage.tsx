...
export const TriageInboxPage = () => {
  ...
  return (
    <div className="flex flex-col w-full h-[calc(100vh-4rem)] bg-transparent overflow-hidden relative">
      {/* Header Panel */}
      <div className="px-6 lg:px-12 py-4 border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 shrink-0 flex flex-col md:flex-row md:items-center justify-between gap-4 z-20">
