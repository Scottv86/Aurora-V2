...
import { AddWorkforceModal } from '../../components/Settings/Workforce/AddWorkforceModal';
...
export const WorkforcePage = () => {
  ...
  const tabs = [
    { id: 'directory', label: 'People Center', icon: Users },
    { id: 'teams', label: 'Team Hub', icon: Network },
    { id: 'roles', label: 'Role Architecture', icon: Shield },
    ...
    switch (activeTab) {
      case 'directory':
        return [
          ...
          { id: 'human', label: 'Human Experts' },
          { id: 'synthetic', label: 'Digital Coworkers' },
          { id: 'status:Active', label: 'Active Only' },
          { id: 'status:Pending', label: 'Pending Slots' }
        ];
      case 'roles':
        return [
  ...
  const getPrimaryAction = () => {
    switch (activeTab) {
      case 'directory':
        return { label: 'Add to Workforce', icon: Plus, onClick: () => setModalMode({ open: true, type: 'human' }) };
      case 'teams':
      ...
      <div className="flex flex-col border-b border-zinc-200 bg-white/50 backdrop-blur-xl dark:border-zinc-800 dark:bg-zinc-950/50">
          ...
          <div className="flex items-start justify-between">
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-[10px] font-extrabold uppercase tracking-[0.25em] text-blue-600 dark:text-blue-400">
                <Zap size={12} className="fill-current" /> Human-AI Orchestration
              </div>
        ...
        <div className="px-10 pb-10">
          <p className="max-w-3xl text-sm font-medium leading-relaxed text-zinc-500">
            ...
            Manage reporting lines, team structures, and security governance in one state-of-the-art interface.
          </p>
        </div>
      ...
      <div className="flex items-center justify-between px-10 py-4 mt-4 bg-zinc-50/50 dark:bg-zinc-900/10 border-b border-zinc-200/50 dark:border-zinc-800/50">
        <div className="flex items-center gap-4">
          <div className="relative group">
            ...
            <input 
              type="text" 
              placeholder="Search resource name, role or ID..." 
              value={searchQuery}
...
const PulseSection = ({ activeTab, members, teams, positions, groups }: any) => {
  ...
  switch (activeTab) {
    case 'directory':
      ...
      stats = [
        { label: 'Total Workforce', value: members.length, icon: Users, color: 'blue' },
        { label: 'Human Experts', value: humanCount, icon: UserCheck, color: 'zinc' },
        { label: 'Digital Coworkers', value: agentCount, icon: Bot, color: 'purple' },
    ...
    case 'teams':
      ...
      stats = [
        ...
        { label: 'Human Capacity', value: totalHumans, icon: Users, color: 'zinc' },
    ...
    case 'roles':
      ...
      stats = [
        ...
        { label: 'Open Vacancies', value: openCount, icon: Plus, color: 'orange' },
        { label: 'Strategic Depth', value: `${depth}%`, icon: TrendingUp, color: 'purple' },
      ];
      break;
    case 'groups':
      ...
      stats = [
        ...
        { label: 'Global Protocols', value: systemGroups, icon: Shield, color: 'zinc' },
        { label: 'Custom Overrides', value: customGroups, icon: Plus, color: 'orange' },
        { label: 'Guardrail Points', value: totalPerms, icon: Target, color: 'purple' },
      ];
      break;
    default:
      return null;
