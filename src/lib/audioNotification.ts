...
/**
 * Synthesizes a crisp, modern incoming chat message chime using Web Audio API
 */
export function playChatNotificationSound(volume = 0.25) {
  try {
    ...
    gain2.gain.linearRampToValueAtTime(volume, now + 0.075);
    ...
    console.warn('[AudioNotification] Chat sound playback inhibited:', e);
  }
}
